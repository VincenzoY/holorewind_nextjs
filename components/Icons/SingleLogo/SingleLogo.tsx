interface SingleLogoProps extends React.SVGProps<SVGSVGElement>  {}

const SingleLogo: React.FC<SingleLogoProps> = (props) => {
    return (
        <svg width="120px" viewBox="7 16 60 60" fill="none" xmlns="http://www.w3.org/2000/svg" className="group relative" {...props}>
